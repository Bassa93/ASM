			...
			driver.findElement(By.xpath("//*[@id=\"onetrust-accept-btn-handler\"]")).click();  // accepter les cookies
			   ...
			   driver.findElement(By.id("myaccount_login_email")).sendKeys("hannachi.basmas93@gmail.com");    // entrer email
				...
				Thread.sleep(2000);
				   ...
				   Thread.sleep(1000);
				   driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[3]/div[2]/div[4]/div/button")).click();  // choisir l'article
				   Thread.sleep(1000);
				   driver.findElement(By.xpath("//*[@id=\"root\"]/div[1]/header/nav/div[4]/button[2]")).click();  // choisir l'article
}
}
