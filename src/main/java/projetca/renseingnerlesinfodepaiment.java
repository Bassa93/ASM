...
public class renseingnerlesinfodepaiment {
			...
			driver.findElement(By.xpath("//*[@id=\"onetrust-accept-btn-handler\"]")).click();  // accepter les cookies
			   ...
			   driver.findElement(By.id("myaccount_login_email")).sendKeys("hannachi.basmas93@gmail.com");    // entrer email
				...
				Thread.sleep(2000);
				   ...
				   Thread.sleep(1000);
				   driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[2]/div/div/div[2]/button/span")).click();  // clique sur j'en profite
				   Thread.sleep(1000);
				   driver.findElement(By.id("number")).sendKeys("15478565478954");    // numero de la carte
				   Thread.sleep(1000);
				   driver.findElement(By.id("holder")).sendKeys("basma");    // nom du la carte
				   Thread.sleep(1000);
				   driver.findElement(By.id("expiry")).sendKeys("07/27");    // validité de la carte
				   Thread.sleep(1000);
				   driver.findElement(By.id("cvc")).sendKeys("07/27");    // cvv
